  ...
  <?php } ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!--<a class="collapse-item" href="#" data-toggle="modal" data-target="#PayModal">Cash Payments</a>-->
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Transction</h6>
            <a class="collapse-item" href="PaidOffences.php?status=PAID">Paid Offences</a>
            <a class="collapse-item" href="PaidOffences.php?status=UNPAID">UnPaid Offences</a>
            <a class="collapse-item" href="PaidOffences.php">All Offences</a>
            <!--
